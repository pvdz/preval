...
export const ALL_NON_PRIMITIVE_TYPE_NAMES = new Set(['object', 'array', 'regex', 'function', 'class', 'promise', 'map', 'set', 'arguments', 'date', 'error', 'typeError', 'iterator', 'buffer', 'uint8Array']);
