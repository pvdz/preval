...
function _ifFlipping(fdata) {
  ...
  function _walker(node, beforeWalk, nodeType, path) {
    ...
    //dit was else maar dat werkt niet met /home/ptr/proj/preval/tests/cases/if_merging/base_value.md
    //het lost wel deze op: /home/ptr/proj/preval/tests/cases/normalize/expressions/assignments/ternary_a/auto_ident_opt_call_simple.md
    //find a way

    // Not a constant or the constant case did not match a rule... be more cautious now.
