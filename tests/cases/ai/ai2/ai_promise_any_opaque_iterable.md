...
const tmpMCOO$1 /*:promise*/ /*truthy*/ = $Promise_any(iterable);
...
$dotCall(
  $promise_catch,
  $dotCall($promise_then, $Promise_any($(`opaque_promise_iterable_any`)), `then`, function (res) {
...
const tmpMCOO$1 = $Promise_any(iterable);
