...
const tmpMCOO$1 /*:promise*/ /*truthy*/ = $Promise_race(iterable);
...
$dotCall(
  $promise_catch,
  $dotCall($promise_then, $Promise_race($(`opaque_promise_iterable_race`)), `then`, function (res) {
...
const tmpMCOO$1 = $Promise_race(iterable);
