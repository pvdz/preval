...
# arguments_parameter_shadowing_define_property.md

> Arguments > Ai > Arguments parameter shadowing define property
>
> Test parameter shadowing with Object.defineProperty

## Input

`````js filename=intro
function testArgsParameterShadowingDefineProperty() {
...
testArgsParameterShadowingDefineProperty(1, 2, 3);
`````
...
`````js filename=intro
const testArgsParameterShadowingDefineProperty /*:()=>undefined*/ = function (/*uses arguments*/) {
...
`````js filename=intro
const testArgsParameterShadowingDefineProperty = function () {
...
`````js filename=intro
let testArgsParameterShadowingDefineProperty = function () {
  const tmpPrevalAliasArgumentsAny = arguments;
