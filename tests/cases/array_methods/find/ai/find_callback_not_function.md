...
> Array methods > Find > Ai > Find callback not function
>
> Test: Array.find throws TypeError when callback is not a function
...
try {
  ...
  $dotCall(tmpMCF, arr, `find`, `not a function`);
} catch (e) {
...
try {
  const c = b.find;
  $dotCall( c, b, "find", "not a function" );
}
catch (d) {
  const e = d.name;
  $( e );
