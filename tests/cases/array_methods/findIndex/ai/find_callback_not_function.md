...
> Array methods > FindIndex > Ai > Find callback not function
>
> Test: Array.findIndex throws TypeError when callback is not a function
...
try {
  ...
  $dotCall(tmpMCF, arr, `findIndex`, `not a function`);
} catch (e) {
...
try {
  const c = b.findIndex;
  $dotCall( c, b, "findIndex", "not a function" );
}
catch (d) {
  const e = d.name;
  $( e );
