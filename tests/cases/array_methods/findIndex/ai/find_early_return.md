...
> Array methods > FindIndex > Ai > Find early return
>
> Test: Array.findIndex early return - should stop after findIndexing first match
...
const i = $dotCall( d, b, "findIndex", e );
$( c );
$( i );
`````
