...
> Array methods > FindIndex > Ai > Find object
>
> Test: Array.findIndex with object predicate
...
$(
  $dotCall(tmpMCF, arr, `findIndex`, function (obj) {
...
const k = $dotCall( f, e, "findIndex", g );
$( k );
`````
