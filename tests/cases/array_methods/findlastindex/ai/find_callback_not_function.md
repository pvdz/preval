...
> Array methods > Findlastindex > Ai > Find callback not function
>
> Test: Array.findLastIndex throws TypeError when callback is not a function
...
try {
  ...
  $dotCall(tmpMCF, arr, `findLastIndex`, `not a function`);
} catch (e) {
...
try {
  ...
  $dotCall( c, b, "findLastIndex", "not a function" );
}
catch (d) {
  const e = d.name;
  $( e );
