...
> Array methods > Findlastindex > Ai > Find early return
>
> Test: Array.findLastIndex early return - should stop after findLastIndexing first match
...
const arr = $([1, 2, 3, 4, 5]);
let count = 0;
const result = arr.findLastIndex(x => {
    count++;
...
const i = $dotCall( d, b, "findLastIndex", e );
$( c );
$( i );
`````
