...
> Array methods > Reduce > Ai > Some without context
>
...
let tmpSSA_tmpArreout$1 /*:unknown*/ = $dotCall(tmpMCP, undefined, undefined, 1, 2, 1, tmpMCOO);
...
if (tmpArrin$2) {
  ...
  if (tmpArrebad$2) {
    ...
    tmpSSA_tmpArreout$1 = $dotCall(tmpMCP, undefined, undefined, tmpSSA_tmpArreout$1, tmpArrel$2, 2, tmpMCOO);
  }
} else {
}
...
const tmpMCOO = [1, 2, 3];
let tmpSSA_tmpArreout$1 = $dotCall(tmpMCP, undefined, undefined, 1, 2, 1, tmpMCOO);
