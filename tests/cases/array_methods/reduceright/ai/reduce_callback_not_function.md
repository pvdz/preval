...
> Array methods > Reduceright > Ai > Reduce callback not function
>
> Test: Array.reduceRight with non-function callback (should throw)
...
try {
  ...
  $dotCall(tmpMCF, arr, `reduceRight`, `not a function`);
} catch (e) {
...
try {
  ...
  $dotCall( c, b, "reduceRight", "not a function" );
}
catch (d) {
  const e = d.name;
  $( e );
