...
# reduceright_single_with_init.md

> Array methods > Reduceright > Ai > Reduceright single with init
>
> Test: Array.reduceRight with single element array and initial value
...
const i = $dotCall( c, b, "reduceRight", d, 10 );
$( i );
`````
