...
> Array methods > Reduceright > Ai > Some non array object
>
...
const x /*:array*/ /*truthy*/ = $dotCall($array_reduceRight, tmpMCP, undefined, tmpMCP$1);
$(x);
`````
...
$($dotCall($array_reduceRight, { [0]: `a`, [1]: `b`, length: 2 }, undefined, tmpMCP$1));
`````
...
const d = $dotCall( $array_reduceRight, c, undefined, a );
$( d );
`````
