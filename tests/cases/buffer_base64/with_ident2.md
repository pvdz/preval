...
const tmpMCF$2 /*:unknown*/ = tmpBufFrom$9.toString;
$dotCall(tmpMCF$2, tmpBufFrom$9, `toString`, `utf8`);
$(`path`);
unknown = `cGF0aA`;
const tmpBufFrom$7 /*:buffer*/ = $dotCall($Buffer_from, Buffer, `from`, `cGF0aA`, `base64`);
const tmpMCF$6 /*:unknown*/ = tmpBufFrom$7.toString;
$dotCall(tmpMCF$6, tmpBufFrom$7, `toString`, `utf8`);
$(`path`);
unknown = `cGF0aA`;
const tmpBufFrom$5 /*:buffer*/ = $dotCall($Buffer_from, Buffer, `from`, `cGF0aA`, `base64`);
const tmpMCF$10 /*:unknown*/ = tmpBufFrom$5.toString;
$dotCall(tmpMCF$10, tmpBufFrom$5, `toString`, `utf8`);
$(`path`);
unknown = `cGF0aA`;
const tmpBufFrom$3 /*:buffer*/ = $dotCall($Buffer_from, Buffer, `from`, `cGF0aA`, `base64`);
const tmpMCF$14 /*:unknown*/ = tmpBufFrom$3.toString;
$dotCall(tmpMCF$14, tmpBufFrom$3, `toString`, `utf8`);
$(`path`);
unknown = `cGF0aA`;
const tmpBufFrom$1 /*:buffer*/ = $dotCall($Buffer_from, Buffer, `from`, `cGF0aA`, `base64`);
const tmpMCF$18 /*:unknown*/ = tmpBufFrom$1.toString;
$dotCall(tmpMCF$18, tmpBufFrom$1, `toString`, `utf8`);
$(`path`);
unknown = `cGF0aA`;
const tmpBufFrom /*:buffer*/ = $dotCall($Buffer_from, Buffer, `from`, `cGF0aA`, `base64`);
const tmpMCF$22 /*:unknown*/ = tmpBufFrom.toString;
$dotCall(tmpMCF$22, tmpBufFrom, `toString`, `utf8`);
$(`path`);
`````
