...
# math_log1p_call_ctx_spread_first.md

> Builtins cases > Ai math > Math log1p call ctx spread first
>
> Test: Math.log1p.call({}, ...[2, 3]) (spread as first argument with context)
