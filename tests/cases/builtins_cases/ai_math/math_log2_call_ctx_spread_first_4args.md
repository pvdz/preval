...
# math_log2_call_ctx_spread_first_4args.md

> Builtins cases > Ai math > Math log2 call ctx spread first 4args
>
> Test: Math.log2.call({}, ...[64, 2, 3, 4]) (spread as first argument with context, 4 values)
