...
# math_log_call_ctx_spread_first_4args.md

> Builtins cases > Ai math > Math log call ctx spread first 4args
>
> Test: Math.log.call({}, ...[1000, 2, 3, 4]) (spread as first argument with context, 4 values)
