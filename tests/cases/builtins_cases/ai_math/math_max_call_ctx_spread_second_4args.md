...
# math_max_call_ctx_spread_second_4args.md

> Builtins cases > Ai math > Math max call ctx spread second 4args
>
> Test: Math.max.call({}, 7, ...[3, 9, 2]) (spread as second argument with context, 4 values)
