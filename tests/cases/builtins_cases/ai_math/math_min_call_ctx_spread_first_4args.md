...
# math_min_call_ctx_spread_first_4args.md

> Builtins cases > Ai math > Math min call ctx spread first 4args
>
> Test: Math.min.call({}, ...[7, 3, 9, 2]) (spread as first argument with context, 4 values)
