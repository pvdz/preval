...
# math_random_call_ctx_0args.md

> Builtins cases > Ai math > Math random call ctx 0args
>
> Test Math.random with call context and 0 arguments

## Input

`````js filename=intro
const result = Math.random.call(null);
$(result >= 0 && result < 1);
...
const result = $dotCall(tmpMCF, tmpMCOO, `call`, null);
