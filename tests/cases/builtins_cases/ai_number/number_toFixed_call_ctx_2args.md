...
# number_toFixed_call_ctx_2args.md

> Builtins cases > Ai number > Number toFixed call ctx 2args
>
> Test Number.prototype.toFixed called with .call and object context, 2 arguments; extra arguments are ignored

## Input

`````js filename=intro
const num = $(42.123);
const result = Number.prototype.toFixed.call(num, 2, "extra");
...
const result = $dotCall(tmpMCF, tmpMCOO, `call`, num, 2, `extra`);
$(result);
`````
