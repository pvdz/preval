...
# number_toFixed_call_ctx_3args.md

> Builtins cases > Ai number > Number toFixed call ctx 3args
>
> Test Number.prototype.toFixed called with .call and object context, 3 arguments; extra arguments are ignored

## Input

`````js filename=intro
const num = $(42.123);
const result = Number.prototype.toFixed.call(num, 2, "extra1", "extra2");
...
const result = $dotCall(tmpMCF, tmpMCOO, `call`, num, 2, `extra1`, `extra2`);
$(result);
`````
