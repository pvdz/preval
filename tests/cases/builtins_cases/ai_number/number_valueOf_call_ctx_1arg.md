...
# number_valueOf_call_ctx_1arg.md

> Builtins cases > Ai number > Number valueOf call ctx 1arg
>
> Test Number.prototype.valueOf called with .call and 1 argument (should be ignored), using a context value

## Input

`````js filename=intro
const ctx = $(456);
const result = Number.prototype.valueOf.call(ctx, 42);
$(result); // Expected: 456
`````
