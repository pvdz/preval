...
# number_valueOf_call_ctx_2args.md

> Builtins cases > Ai number > Number valueOf call ctx 2args
>
> Test Number.prototype.valueOf called with .call and 2 arguments (should be ignored), using a context value

## Input

`````js filename=intro
const ctx = $(456);
const result = Number.prototype.valueOf.call(ctx, 1, 2);
$(result); // Expected: 456
`````
