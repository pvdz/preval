...
# string_bold_call_ctx_2args.md

> Builtins cases > Ai string > String bold call ctx 2args
>
> Test String.prototype.bold called with .call and object context, 2 arguments; extra arguments are ignored

## Input

`````js filename=intro
const str = $("hello world");
const result = String.prototype.bold.call(str, "extra1", "extra2");
