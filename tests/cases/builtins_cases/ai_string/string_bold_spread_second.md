...
# string_bold_spread_second.md

> Builtins cases > Ai string > String bold spread second
>
> Test String.prototype.bold called directly with spread as second argument (3 values, all ignored)
...
const result = str.bold(arg1, ...args);
...
const result = $dotCall(tmpMCF, str, `bold`, arg1, ...args);
$(result);
`````
