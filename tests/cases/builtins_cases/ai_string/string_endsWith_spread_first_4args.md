...
# string_endsWith_spread_first_4args.md

> Builtins cases > Ai string > String endsWith spread first 4args
>
> Test String.prototype.endsWith called directly with spread as first argument (4 values)

## Input

`````js filename=intro
const str = $("hello world");
const args = ["world", 11, "extra1", "extra2"];
