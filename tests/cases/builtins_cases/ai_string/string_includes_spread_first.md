...
# string_includes_spread_first.md

> Builtins cases > Ai string > String includes spread first
>
> Test String.prototype.includes called directly with spread as first argument (3 values)
