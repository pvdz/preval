...
# string_isWellFormed_call_ctx_1arg.md

> Builtins cases > Ai string > String isWellFormed call ctx 1arg
>
> Test String.prototype.isWellFormed called with .call and 1 argument (should be ignored), using a context value

## Input

`````js filename=intro
const ctx = $("world");
const result = String.prototype.isWellFormed.call(ctx, 42);
