...
# string_isWellFormed_call_ctx_4args.md

> Builtins cases > Ai string > String isWellFormed call ctx 4args
>
> Test String.prototype.isWellFormed called with .call and 4 arguments (should be ignored), using a context value

## Input

`````js filename=intro
const ctx = $("world");
const result = String.prototype.isWellFormed.call(ctx, 1, 2, 3, 4);
