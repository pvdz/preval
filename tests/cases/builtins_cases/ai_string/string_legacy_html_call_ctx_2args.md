...
# string_legacy_html_call_ctx_2args.md

> Builtins cases > Ai string > String legacy html call ctx 2args
>
> Test all legacy HTML String methods called with .call and object context, 2 arguments; extra arguments are ignored where not used

## Input

`````js filename=intro
const str = $("hello world");
$(String.prototype.anchor.call(str, "extra1", "extra2"));
$(String.prototype.big.call(str, "extra1", "extra2"));
$(String.prototype.blink.call(str, "extra1", "extra2"));
$(String.prototype.bold.call(str, "extra1", "extra2"));
$(String.prototype.fixed.call(str, "extra1", "extra2"));
$(String.prototype.fontcolor.call(str, "red", "extra2"));
$(String.prototype.fontsize.call(str, 7, "extra2"));
$(String.prototype.italics.call(str, "extra1", "extra2"));
$(String.prototype.link.call(str, "https://example.com", "extra2"));
$(String.prototype.small.call(str, "extra1", "extra2"));
$(String.prototype.strike.call(str, "extra1", "extra2"));
$(String.prototype.sub.call(str, "extra1", "extra2"));
$(String.prototype.sup.call(str, "extra1", "extra2"));
`````
