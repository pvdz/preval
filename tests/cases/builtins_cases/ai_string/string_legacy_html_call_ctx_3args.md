...
# string_legacy_html_call_ctx_3args.md

> Builtins cases > Ai string > String legacy html call ctx 3args
>
> Test all legacy HTML String methods called with .call and object context, 3 arguments; extra arguments are ignored where not used

## Input

`````js filename=intro
const str = $("hello world");
$(String.prototype.anchor.call(str, "extra1", "extra2", "extra3"));
$(String.prototype.big.call(str, "extra1", "extra2", "extra3"));
$(String.prototype.blink.call(str, "extra1", "extra2", "extra3"));
$(String.prototype.bold.call(str, "extra1", "extra2", "extra3"));
$(String.prototype.fixed.call(str, "extra1", "extra2", "extra3"));
$(String.prototype.fontcolor.call(str, "red", "extra2", "extra3"));
$(String.prototype.fontsize.call(str, 7, "extra2", "extra3"));
$(String.prototype.italics.call(str, "extra1", "extra2", "extra3"));
$(String.prototype.link.call(str, "https://example.com", "extra2", "extra3"));
$(String.prototype.small.call(str, "extra1", "extra2", "extra3"));
$(String.prototype.strike.call(str, "extra1", "extra2", "extra3"));
$(String.prototype.sub.call(str, "extra1", "extra2", "extra3"));
$(String.prototype.sup.call(str, "extra1", "extra2", "extra3"));
`````
