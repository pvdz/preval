...
# string_legacy_html_spread_second_4args.md

> Builtins cases > Ai string > String legacy html spread second 4args
>
> Test all legacy HTML String methods called directly with spread as second argument (4 values, all ignored where not used)
...
const args /*:array*/ /*truthy*/ = [`extra2`, `extra3`, `extra4`, `extra5`];
...
const a = $( "hello world" );
const b = a.anchor;
const c = [ "extra2", "extra3", "extra4", "extra5" ];
