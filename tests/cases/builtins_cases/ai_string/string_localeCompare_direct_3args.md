...
# string_localeCompare_direct_3args.md

> Builtins cases > Ai string > String localeCompare direct 3args
>
> Test 'localeCompare' called directly with three arguments on a string instance
...
let tmpCalleeParam = $dotCall(tmpMCF, `abc`, `localeCompare`, `abd`, `en`, tmpMCP);
$(tmpCalleeParam);
`````
