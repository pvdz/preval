...
# string_matchAll_call_ctx_1arg.md

> Builtins cases > Ai string > String matchAll call ctx 1arg
>
> Test 'matchAll' called with .call and object context, one argument

## Input

`````js filename=intro
$(Array.from(String.prototype.matchAll.call("abcabc", /a./g)));
// Expected: [["ab"], ["ab"]]
`````
...
const tmpMCP = $dotCall(tmpMCF$1, tmpMCOO, `call`, `abcabc`, tmpMCP$1);
