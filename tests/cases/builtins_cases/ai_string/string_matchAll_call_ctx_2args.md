...
# string_matchAll_call_ctx_2args.md

> Builtins cases > Ai string > String matchAll call ctx 2args
>
> Test 'matchAll' called with .call and object context, two arguments

## Input

`````js filename=intro
$(Array.from(String.prototype.matchAll.call("abcabc", /a./g, "extra")));
// Expected: [["ab"], ["ab"]]
`````
...
const tmpMCP = $dotCall(tmpMCF$1, tmpMCOO, `call`, `abcabc`, tmpMCP$1, `extra`);
