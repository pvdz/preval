...
# string_matchAll_call_ctx_spread_second.md

> Builtins cases > Ai string > String matchAll call ctx spread second
>
> Test 'matchAll' called with .call and object context, spread as second argument (three values)
