...
# string_matchAll_call_ctx_spread_second_4args.md

> Builtins cases > Ai string > String matchAll call ctx spread second 4args
>
> Test 'matchAll' called with .call and object context, spread as second argument (four values)

## Input

`````js filename=intro
$(Array.from(String.prototype.matchAll.call("abcabc", /a./g, ...$["extra", 42, null, undefined])));
// Expected: [["ab"], ["ab"]]
`````
...
[...tmpMCSP];
$($Array_from($dotCall($string_matchAll, `abcabc`, undefined, tmpMCP$1)));
`````
...
const b = $.undefined;
[ ...b ];
const c = $dotCall( $string_matchAll, "abcabc", undefined, a );
...
const tmpMCP = $dotCall(tmpMCF$1, tmpMCOO, `call`, `abcabc`, tmpMCP$1, ...tmpMCSP);
