...
# string_matchAll_direct_2args.md

> Builtins cases > Ai string > String matchAll direct 2args
>
> Test 'matchAll' called directly with two arguments on a string instance (extra arg ignored)

## Input

`````js filename=intro
$(Array.from("abcabc".matchAll(/a./g, "extra")));
// Expected: [["ab"], ["ab"]]
`````
...
const tmpMCP = $dotCall(tmpMCF$1, `abcabc`, `matchAll`, tmpMCP$1, `extra`);
