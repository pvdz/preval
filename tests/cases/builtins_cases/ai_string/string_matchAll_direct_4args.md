...
# string_matchAll_direct_4args.md

> Builtins cases > Ai string > String matchAll direct 4args
>
> Test 'matchAll' called directly with four arguments on a string instance (extra args ignored)
...
const tmpMCP = $dotCall(tmpMCF$1, `abcabc`, `matchAll`, tmpMCP$1, `extra`, 42, null);
