...
# string_matchAll_spread_second.md

> Builtins cases > Ai string > String matchAll spread second
>
> Test 'matchAll' called directly with spread as second argument (three values)
