...
# string_match_call_ctx_spread_first.md

> Builtins cases > Ai string > String match call ctx spread first
>
> Test 'match' called with .call and object context, spread as first argument (three values)
