...
# string_match_direct_3args.md

> Builtins cases > Ai string > String match direct 3args
>
> Test 'match' called directly with three arguments on a string instance (extra args ignored)
