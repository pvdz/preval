...
# string_match_spread_first_4args.md

> Builtins cases > Ai string > String match spread first 4args
>
> Test 'match' called directly with spread as first argument (four values)
