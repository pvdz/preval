...
# string_normalize_call_ctx_spread_second.md

> Builtins cases > Ai string > String normalize call ctx spread second
>
> Test 'normalize' called with .call and object context, spread as second argument (three values)
