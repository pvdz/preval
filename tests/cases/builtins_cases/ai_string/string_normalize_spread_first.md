...
# string_normalize_spread_first.md

> Builtins cases > Ai string > String normalize spread first
>
> Test 'normalize' called directly with spread as first argument (three values)
