...
# string_padEnd_call_ctx_spread_second_4args.md

> Builtins cases > Ai string > String padEnd call ctx spread second 4args
>
> Test 'padEnd' called with .call and object context, spread as second argument (four values)

## Input

`````js filename=intro
$(String.prototype.padEnd.call("abc", 6, ...$(["*", 42, null, undefined])));
// Expected: "abc***"
`````
