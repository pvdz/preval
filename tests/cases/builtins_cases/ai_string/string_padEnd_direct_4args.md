...
# string_padEnd_direct_4args.md

> Builtins cases > Ai string > String padEnd direct 4args
>
> Test 'padEnd' called directly with four arguments on a string instance (extra args ignored)
