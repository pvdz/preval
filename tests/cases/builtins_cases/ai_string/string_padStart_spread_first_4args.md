...
# string_padStart_spread_first_4args.md

> Builtins cases > Ai string > String padStart spread first 4args
>
> Test 'padStart' called directly with spread as first argument (four values)
