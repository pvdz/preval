...
# string_search_call_ctx_1arg.md

> Builtins cases > Ai string > String search call ctx 1arg
>
> Test String.prototype.search called with .call and object context, 1 argument

## Input

`````js filename=intro
const str = $("hello world");
const result = String.prototype.search.call(str, /world/);
$(result); // Expected: 6
`````
...
const result = $dotCall(tmpMCF, tmpMCOO, `call`, str, tmpMCP);
$(result);
`````
