...
# string_search_call_ctx_4args.md

> Builtins cases > Ai string > String search call ctx 4args
>
> Test String.prototype.search called with .call and object context, 4 arguments; extra arguments are ignored

## Input

`````js filename=intro
const str = $("hello world");
const result = String.prototype.search.call(str, /world/, "extra1", "extra2", "extra3");
$(result); // Expected: 6
`````
...
const result = $dotCall(tmpMCF, tmpMCOO, `call`, str, tmpMCP, `extra1`, `extra2`, `extra3`);
$(result);
`````
