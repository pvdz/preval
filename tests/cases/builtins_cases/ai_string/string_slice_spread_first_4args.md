...
# string_slice_spread_first_4args.md

> Builtins cases > Ai string > String slice spread first 4args
>
> Test String.prototype.slice called directly with spread as first argument (4 values)
