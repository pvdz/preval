...
# string_split_call_ctx_spread_second.md

> Builtins cases > Ai string > String split call ctx spread second
>
> Test 'split' called with .call and object context, spread as second argument (three values)
