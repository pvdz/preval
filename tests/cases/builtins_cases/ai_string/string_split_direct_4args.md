...
# string_split_direct_4args.md

> Builtins cases > Ai string > String split direct 4args
>
> Test 'split' called directly with four arguments on a string instance (extra args ignored)
