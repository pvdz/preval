...
# string_substr_call_ctx_3args.md

> Builtins cases > Ai string > String substr call ctx 3args
>
> Test String.prototype.substr called with .call and 3 arguments (extra argument ignored), using a context value

## Input

`````js filename=intro
const ctx = $("world");
const result = String.prototype.substr.call(ctx, 1, 3, 99);
$(result); // Expected: "orl"
`````
...
const result = $dotCall(tmpMCF, tmpMCOO, `call`, ctx, 1, 3, 99);
$(result);
`````
