...
# string_substring_call_ctx_2args.md

> Builtins cases > Ai string > String substring call ctx 2args
>
> Test String.prototype.substring called with .call and object context, 2 arguments

## Input

`````js filename=intro
const str = $("hello world");
const result = String.prototype.substring.call(str, 0, 5);
...
const result = $dotCall(tmpMCF, tmpMCOO, `call`, str, 0, 5);
$(result);
`````
