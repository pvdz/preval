...
# string_substring_spread_first_4args.md

> Builtins cases > Ai string > String substring spread first 4args
>
> Test String.prototype.substring called directly with spread as first argument (4 values)

## Input

`````js filename=intro
const str = $("hello world");
const args = [0, 5, "extra1", "extra2"];
