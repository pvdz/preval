...
# string_toLocaleLowerCase_call_ctx_1arg.md

> Builtins cases > Ai string > String toLocaleLowerCase call ctx 1arg
>
> Test String.prototype.toLocaleLowerCase called with .call and 1 argument (locale), using a context value

## Input

`````js filename=intro
const ctx = $("WORLD");
const result = String.prototype.toLocaleLowerCase.call(ctx, "en-US");
...
const result = $dotCall(tmpMCF, tmpMCOO, `call`, ctx, `en-US`);
$(result);
`````
