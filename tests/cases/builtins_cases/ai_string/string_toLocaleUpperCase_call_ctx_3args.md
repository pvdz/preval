...
# string_toLocaleUpperCase_call_ctx_3args.md

> Builtins cases > Ai string > String toLocaleUpperCase call ctx 3args
>
> Test String.prototype.toLocaleUpperCase called with .call and 3 arguments (extra arguments ignored), using a context value

## Input

`````js filename=intro
const ctx = $("world");
const result = String.prototype.toLocaleUpperCase.call(ctx, "en-US", 1, 2);
