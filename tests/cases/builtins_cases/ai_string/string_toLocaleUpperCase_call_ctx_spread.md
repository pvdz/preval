...
# string_toLocaleUpperCase_call_ctx_spread.md

> Builtins cases > Ai string > String toLocaleUpperCase call ctx spread
>
> Test String.prototype.toLocaleUpperCase called with .call and spread arguments (array with 1 element), using a context value
...
const ctx = $("world");
const args = ["en-US"];
const result = String.prototype.toLocaleUpperCase.call(ctx, ...args);
