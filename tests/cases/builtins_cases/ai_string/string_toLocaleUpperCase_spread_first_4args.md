...
# string_toLocaleUpperCase_spread_first_4args.md

> Builtins cases > Ai string > String toLocaleUpperCase spread first 4args
>
> Test String.prototype.toLocaleUpperCase called with spread arguments (array with 4 elements, only first used)
