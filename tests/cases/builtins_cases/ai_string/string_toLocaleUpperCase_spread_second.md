...
# string_toLocaleUpperCase_spread_second.md

> Builtins cases > Ai string > String toLocaleUpperCase spread second
>
> Test String.prototype.toLocaleUpperCase called with spread arguments as second argument (should be ignored)
