...
# string_toLowerCase_spread_first_4args.md

> Builtins cases > Ai string > String toLowerCase spread first 4args
>
> Test String.prototype.toLowerCase called directly with spread as first argument (four values)
