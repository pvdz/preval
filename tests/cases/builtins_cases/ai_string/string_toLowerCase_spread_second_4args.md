...
# string_toLowerCase_spread_second_4args.md

> Builtins cases > Ai string > String toLowerCase spread second 4args
>
> Test String.prototype.toLowerCase called directly with spread as second argument (four values)

## Input

`````js filename=intro
$("AbC".toLowerCase(1, ...$([2, 3, 4, 5])));
// Expected: "abc"
`````
