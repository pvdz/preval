...
# string_toString_call_ctx_1arg.md

> Builtins cases > Ai string > String toString call ctx 1arg
>
> Test String.prototype.toString called with .call and object context, 1 argument; extra arguments are ignored

## Input

`````js filename=intro
const str = $("hello world");
const result = String.prototype.toString.call(str, "extra");
