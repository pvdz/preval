...
# string_toString_call_ctx_3args.md

> Builtins cases > Ai string > String toString call ctx 3args
>
> Test String.prototype.toString called with .call and object context, 3 arguments; extra arguments are ignored

## Input

`````js filename=intro
const str = $("hello world");
const result = String.prototype.toString.call(str, "extra1", "extra2", "extra3");
