...
# string_toString_spread_first_4args.md

> Builtins cases > Ai string > String toString spread first 4args
>
> Test String.prototype.toString called directly with spread as first argument (4 values, all ignored)
