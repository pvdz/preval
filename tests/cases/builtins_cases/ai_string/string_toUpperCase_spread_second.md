...
# string_toUpperCase_spread_second.md

> Builtins cases > Ai string > String toUpperCase spread second
>
> Test String.prototype.toUpperCase called directly with spread as second argument (three values)
