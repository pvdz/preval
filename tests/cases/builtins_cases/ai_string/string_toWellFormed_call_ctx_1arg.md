...
# string_toWellFormed_call_ctx_1arg.md

> Builtins cases > Ai string > String toWellFormed call ctx 1arg
>
> Test String.prototype.toWellFormed called with .call and 1 argument (should be ignored), using a context value

## Input

`````js filename=intro
const ctx = $("world");
const result = String.prototype.toWellFormed.call(ctx, 42);
