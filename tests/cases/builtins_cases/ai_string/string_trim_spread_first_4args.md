...
# string_trim_spread_first_4args.md

> Builtins cases > Ai string > String trim spread first 4args
>
> Test String.prototype.trim called directly with spread as first argument (four values)
