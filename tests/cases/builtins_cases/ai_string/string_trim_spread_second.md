...
# string_trim_spread_second.md

> Builtins cases > Ai string > String trim spread second
>
> Test String.prototype.trim called directly with spread as second argument (three values)
