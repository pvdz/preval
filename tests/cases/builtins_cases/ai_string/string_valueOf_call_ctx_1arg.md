...
# string_valueOf_call_ctx_1arg.md

> Builtins cases > Ai string > String valueOf call ctx 1arg
>
> Test String.prototype.valueOf called with .call and 1 argument (should be ignored), using a context value

## Input

`````js filename=intro
const ctx = $("world");
const result = String.prototype.valueOf.call(ctx, 42);
