...
# string_valueOf_call_ctx_2args.md

> Builtins cases > Ai string > String valueOf call ctx 2args
>
> Test String.prototype.valueOf called with .call and 2 arguments (should be ignored), using a context value

## Input

`````js filename=intro
const ctx = $("world");
const result = String.prototype.valueOf.call(ctx, 1, 2);
