...
# string_valueOf_spread_first.md

> Builtins cases > Ai string > String valueOf spread first
>
> Test String.prototype.valueOf called with spread arguments (array with 1 element, should be ignored)
