...
('<hoisted var `a` decl without init>');
('<hoisted var `b` decl without init>');
('<hoisted var `c` decl without init>');
('<hoisted var `d` decl without init>');
('<hoisted var `e` decl without init>');
('<hoisted var `obja` decl without init>');
('<hoisted var `objb` decl without init>');
('<hoisted var `objc` decl without init>');
('<hoisted var `objd` decl without init>');
('<hoisted var `obje` decl without init>');
('<hoisted var `tmpArg$1` decl without init>');
('<hoisted var `tmpNestedAssignComMemberObj` decl without init>');
('<hoisted var `tmpNestedAssignComMemberObj$1` decl without init>');
('<hoisted var `tmpNestedAssignComMemberObj$2` decl without init>');
('<hoisted var `tmpNestedAssignComMemberObj$3` decl without init>');
('<hoisted var `tmpNestedAssignComMemberProp` decl without init>');
('<hoisted var `tmpNestedAssignComMemberProp$1` decl without init>');
('<hoisted var `tmpNestedAssignComMemberProp$2` decl without init>');
('<hoisted var `tmpNestedAssignComMemberProp$3` decl without init>');
('<hoisted var `tmpNestedAssignCompMemberObj` decl without init>');
('<hoisted var `tmpNestedAssignCompMemberObj$1` decl without init>');
('<hoisted var `tmpNestedAssignCompMemberObj$2` decl without init>');
('<hoisted var `tmpNestedAssignCompMemberObj$3` decl without init>');
('<hoisted var `tmpNestedAssignCompMemberProp` decl without init>');
('<hoisted var `tmpNestedAssignCompMemberProp$1` decl without init>');
('<hoisted var `tmpNestedAssignCompMemberProp$2` decl without init>');
('<hoisted var `tmpNestedAssignCompMemberProp$3` decl without init>');
('<hoisted var `tmpNestedAssignCompMemberRhs` decl without init>');
('<hoisted var `tmpNestedAssignCompMemberRhs$1` decl without init>');
('<hoisted var `tmpNestedAssignCompMemberRhs$2` decl without init>');
('<hoisted var `tmpNestedAssignCompMemberRhs$3` decl without init>');
('<hoisted var `tmpNestedAssignObj` decl without init>');
('<hoisted var `tmpNestedAssignObj$1` decl without init>');
('<hoisted var `tmpNestedAssignObj$2` decl without init>');
('<hoisted var `tmpNestedAssignObj$3` decl without init>');
('<hoisted var `a` decl without init>');
('<hoisted var `b` decl without init>');
('<hoisted var `c` decl without init>');
('<hoisted var `d` decl without init>');
