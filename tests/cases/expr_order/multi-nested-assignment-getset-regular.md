...
('<hoisted var `tmpNestedAssignMemberObj` decl without init>');
('<hoisted var `tmpNestedAssignMemberObj$1` decl without init>');
('<hoisted var `tmpNestedAssignMemberObj$2` decl without init>');
('<hoisted var `tmpNestedAssignMemberObj$3` decl without init>');
('<hoisted var `tmpNestedAssignMemberRhs` decl without init>');
('<hoisted var `tmpNestedAssignMemberRhs$1` decl without init>');
('<hoisted var `tmpNestedAssignMemberRhs$2` decl without init>');
('<hoisted var `tmpNestedAssignMemberRhs$3` decl without init>');
