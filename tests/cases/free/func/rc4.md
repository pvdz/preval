...
const DECODER_FUNC /*:()=>string*/ = function () {
  ...
  const tmpClusterSSA_tmpSSA__0x3849a1$2 /*:string*/ = $Global_decodeURIComponent(_0x3f61ee$1);
  let tmpClusterSSA__0x2f4501$1 /*:number*/ = 0;
...
const DECODER_FUNC = function () {
  ...
  const tmpClusterSSA_tmpSSA__0x3849a1$2 = $Global_decodeURIComponent(_0x3f61ee$1);
...
const bm = function() {
  ...
  const ck = $Global_decodeURIComponent( bq );
  let cl = 0;
...
const BASESIXTANDURLDECODE = function ($$0) {
  ...
  const tmpReturnArg$3 = $Global_decodeURIComponent(_0x3f61ee$2);
  return tmpReturnArg$3;
};
