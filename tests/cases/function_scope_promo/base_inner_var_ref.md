...
let h = function () {
  ...
  let f = function () {
    ...
    const tmpBranchingA$1 = function ($$0, $$1) {
      ...
      $('simple');
      $('inlining');
      const tmpReturnArg$4 = tmpBranchingC$1(g$1, x$1);
    ...
    const tmpBranchingB$1 = function ($$0, $$1) {
      ...
      let x$2 = $$1;
      debugger;
      const tmpReturnArg$5 = tmpBranchingC$1(g$2, x$2);
    ...
    if ($) {
      const tmpReturnArg$7 = tmpBranchingA$1(g, x);
      return tmpReturnArg$7;
    } else {
      const tmpReturnArg$8 = tmpBranchingB$1(g, x);
