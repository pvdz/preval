...
let h = function () {
  ...
  let f = function () {
    ...
    const tmpBranchingA$1 = function ($$0, $$1) {
      ...
      $('simple');
      $('inlining');
      const tmpReturnArg$7 = tmpBranchingC$1(g$1, x$1);
    ...
    const tmpBranchingB$1 = function ($$0, $$1) {
      ...
      let x$3 = $$1;
      debugger;
      const tmpReturnArg$9 = tmpBranchingC$1(g$3, x$3);
    ...
    if ($) {
      const tmpReturnArg$13 = tmpBranchingA$1(g, x);
      return tmpReturnArg$13;
    } else {
      const tmpReturnArg$15 = tmpBranchingB$1(g, x);
