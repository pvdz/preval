...
let h = function ($$0) {
  ...
  const tmpBranchingA$3 = function ($$0, $$1) {
    ...
    $('simple');
    $('inlining');
    const tmpReturnArg$17 = tmpBranchingC$3(x$1, f$1);
  ...
  const tmpBranchingB$3 = function ($$0, $$1) {
    ...
    let f$3 = $$1;
    debugger;
    const tmpReturnArg$19 = tmpBranchingC$3(x$3, f$3);
  ...
  if ($) {
    const tmpReturnArg$23 = tmpBranchingA$3(x, f);
    return tmpReturnArg$23;
  } else {
    const tmpReturnArg$25 = tmpBranchingB$3(x, f);
...
const tmpCalleeParam$1 = $(10);
const tmpCalleeParam = h(tmpCalleeParam$1);
$(tmpCalleeParam);
`````
