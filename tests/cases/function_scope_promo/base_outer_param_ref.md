...
let h = function ($$0) {
  ...
  const tmpBranchingA$2 = function ($$0, $$1) {
    ...
    $('simple');
    $('inlining');
    const tmpReturnArg$9 = tmpBranchingC$2(x$1, f$1);
  ...
  const tmpBranchingB$2 = function ($$0, $$1) {
    ...
    let f$2 = $$1;
    debugger;
    const tmpReturnArg$10 = tmpBranchingC$2(x$2, f$2);
  ...
  if ($) {
    const tmpReturnArg$12 = tmpBranchingA$2(x, f);
    return tmpReturnArg$12;
  } else {
    const tmpReturnArg$13 = tmpBranchingB$2(x, f);
