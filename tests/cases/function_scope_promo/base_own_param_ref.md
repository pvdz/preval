...
let h = function () {
  ...
  let f = function () {
    ...
    const tmpBranchingC$1 = function ($$0) {
      let g$3 = $$0;
      debugger;
      const tmpCallCallee = g$3;
      const tmpCalleeParam = $(10);
      const tmpReturnArg$6 = tmpCallCallee(tmpCalleeParam);
...
const h = function () {
  ...
  const f = function () {
    ...
    const tmpBranchingC$1 = function ($$0) {
      ...
      debugger;
      const tmpCalleeParam = $(10);
      const tmpReturnArg$6 = g$3(tmpCalleeParam);
      return tmpReturnArg$6;
    };
    if ($) {
      $('prevent');
      $('simple');
      $('inlining');
      const tmpReturnArg$4 = tmpBranchingC$1(g);
      return tmpReturnArg$4;
    } else {
      const tmpReturnArg$8 = tmpBranchingC$1(g);
      return tmpReturnArg$8;
    }
  };
  if ($) {
