...
> normalize > assignment > logic-both > ident_computed_member_simple_assign
>
...
let d = 4;
{
  ...
  if (tmpAssignLogicStmtOr) {
    tmpNestedAssignComMemberObj_2 = b;
    tmpNestedAssignComMemberProp_2 = $('x');
    ...
    tmpNestedAssignComMemberObj_3 = tmpNestedAssignObj_1;
    tmpNestedAssignComMemberProp_3 = $('y');
