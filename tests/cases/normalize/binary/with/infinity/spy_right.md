...
> Normalize > Binary > With > Infinity > Spy right
>
...
`````js filename=intro
const a = $spy();
const b = $Number_POSITIVE_INFINITY ** a;
...
const i = 0 >> a;
const j = 0 >>> a;
const k = $Number_POSITIVE_INFINITY < a;
...
const q = 0 ^ a;
const r = 0 | a;
const s = $Number_POSITIVE_INFINITY === a;
const t = $Number_POSITIVE_INFINITY !== a;
const u = [ b, c, d, e, f, g, h, i, j, k, l, m, n, o, p, s, t, 0, q, r ];
$( u );
const v = $Number_POSITIVE_INFINITY in a;
$( v );
const w = $Number_POSITIVE_INFINITY instanceof a;
$( w );
`````
...
Should call `$` with:
 ...
 - 18: '$spy[1].valueOf()'
 - 19: '$spy[1].valueOf()'
 - 20: [Infinity, Infinity, Infinity, NaN, Infinity, Infinity, 0, 0, 0, false, true, false, true, false, true, false, true, 0, 12345, 12345]
 - 21: false
