...
const h = a - $Number_NEGATIVE_INFINITY;
const i = a << 0;
const j = a >> 0;
const k = a >>> 0;
...
const q = a != $Number_NEGATIVE_INFINITY;
a ** 0;
const r = a ^ 0;
const s = a | 0;
const t = [ c, d, e, f, g, h, i, j, k, l, m, n, o, p, q, false, true, 0, r, s ];
$( t );
const u = a in $Number_NEGATIVE_INFINITY;
$( u );
const v = a instanceof $Number_NEGATIVE_INFINITY;
$( v );
`````
