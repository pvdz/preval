...
> Normalize > Binary > With > Neg infinity > Unknown string left
>
...
const tmpArrElement$7 /*:string*/ = x + $Number_NEGATIVE_INFINITY;
...
$( t );
const u = b in $Number_NEGATIVE_INFINITY;
$( u );
const v = b instanceof $Number_NEGATIVE_INFINITY;
$( v );
`````
...
Should call `$` with:
 - 1: 'ok'
 - 2: [NaN, NaN, NaN, NaN, 'ok-Infinity', NaN, 0, 0, 0, false, false, false, false, false, true, false, true, 0, 0, 0]
