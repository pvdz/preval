...
Should call `$` with:
 - 1: 1
 - 2: [NaN, NaN, NaN, NaN, '[object Object]2', NaN, 0, 0, 0, false, false, false, false, false, true, false, true, 0, 2, 2]
 - eval returned: ("<crash[ Cannot use 'in' operator to search for '#<Object>' in 2 ]>")
