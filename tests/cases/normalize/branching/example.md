...
const tmpCalleeParam = function (anode, i) {
  const tmpBranchingA = function (anode$1, i$1) {
    let valueNode$1 = anode$1;
    const tmpBinLhs$3 = anode$1.type;
    const tmpIfTest$4 = tmpBinLhs$3 === 'SpreadElement';
    const tmpBranchingA$1 = function (anode$4, i$4, valueNode$2, tmpBinLhs$6, tmpIfTest$8) {
    ...
    const tmpBranchingB$1 = function (anode$5, i$5, valueNode$3, tmpBinLhs$7, tmpIfTest$9) {
      const tmpReturnArg$3 = tmpBranchingC$1(anode$5, i$5, valueNode$3, tmpBinLhs$7, tmpIfTest$9);
      return tmpReturnArg$3;
    };
    const tmpBranchingC$1 = function (anode$6, i$6, valueNode$4, tmpBinLhs$8, tmpIfTest$10) {
      const tmpIfTest$11 = isComplexNode(valueNode$4);
      const tmpBranchingA$2 = function (anode$7, i$7, valueNode$5, tmpBinLhs$11, tmpIfTest$14, tmpIfTest$15) {
      ...
      const tmpBranchingB$2 = function (anode$8, i$8, valueNode$6, tmpBinLhs$13, tmpIfTest$17, tmpIfTest$18) {
      ...
      const tmpBranchingC$2 = function (anode$9, i$9, valueNode$7, tmpBinLhs$14, tmpIfTest$19, tmpIfTest$20) {
  ...
  const tmpBranchingB = function (anode$2, i$2) {
    const tmpReturnArg$1 = newElements.push(null);
    return tmpReturnArg$1;
  };
  const tmpBranchingC = function (anode$3, i$3) {};
  if (anode) {
...
const tmpCallVal = tmpCallObj.forEach;
const tmpCalleeParam = function (anode, i) {
  const tmpBranchingA = function (anode$1) {
    const tmpBinLhs$3 = anode$1.type;
    const tmpIfTest$4 = tmpBinLhs$3 === 'SpreadElement';
    const tmpBranchingC$1 = function (anode$6, valueNode$4) {
      const tmpIfTest$11 = isComplexNode(valueNode$4);
      const tmpBranchingA$2 = function (anode$7, valueNode$5) {
        const tmpName$3 = createFreshVarInCurrentRootScope('tmpElement', true);
        const tmpCallObj$7 = assigns;
        const tmpCallVal$7 = tmpCallObj$7.push;
        const tmpCalleeParam$7 = AST.assignmentExpression(tmpName$3, valueNode$5);
        ...
        const tmpBinLhs$12 = anode$7.type;
        const tmpIfTest$16 = tmpBinLhs$12 === 'SpreadElement';
        const tmpBranchingC$3 = function (anode$12, valueNode$10, tmpCallObj$14, tmpCallVal$14, tmpCalleeParam$14) {
          tmpCallVal$14.call(tmpCallObj$14, tmpCalleeParam$14);
      ...
      const tmpBranchingC$2 = function (anode$9, valueNode$7) {
        const tmpBinLhs$15 = anode$9.type;
        const tmpIfTest$21 = tmpBinLhs$15 === 'SpreadElement';
        if (tmpIfTest$21) {
