...
let f = function () {
  ...
  const tmpBranchingA = function ($$0) {
    ...
    if (tmpIfTest$3) {
      const tmpReturnArg$9 = tmpBranchingA$1(tmpIfTest$2, tmpIfTest$3);
      return tmpReturnArg$9;
    } else {
      const tmpReturnArg$10 = tmpBranchingB$1(tmpIfTest$2, tmpIfTest$3);
