...
> Normalize > Expressions > Assignments > Arr element > Auto ident call computed s-seq complex
>
...
const tmpClusterSSA_a$1 /*:unknown*/ = $dotCall(tmpCallCompVal$1, b, undefined, 1);
...
const tmpClusterSSA_a$1 = b[tmpCallCompProp$1](1);
