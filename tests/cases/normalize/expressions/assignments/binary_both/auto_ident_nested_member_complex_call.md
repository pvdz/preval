...
> Normalize > Expressions > Assignments > Binary both > Auto ident nested member complex call
>
...
const tmpCalleeParam /*:primitive*/ = varInitAssignLhsComputedRhs + varInitAssignLhsComputedRhs$1;
$(tmpCalleeParam);
