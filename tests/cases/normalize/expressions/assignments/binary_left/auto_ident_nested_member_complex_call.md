...
> Normalize > Expressions > Assignments > Binary left > Auto ident nested member complex call
>
...
const tmpCalleeParam /*:primitive*/ = tmpInitAssignLhsComputedRhs + tmpBinBothRhs;
$(tmpCalleeParam);
...
tmpInitAssignLhsComputedObj[tmpInitAssignLhsComputedProp] = tmpInitAssignLhsComputedRhs;
tmpNestedAssignComMemberObj[tmpNestedAssignComMemberProp] = tmpInitAssignLhsComputedRhs;
$(tmpInitAssignLhsComputedRhs + $(100));
$(tmpInitAssignLhsComputedRhs, b, c, 3);
`````
