...
> Normalize > Expressions > Assignments > Binary right > Auto ident nested member complex call
>
...
const tmpCalleeParam /*:primitive*/ = tmpBinBothLhs + tmpInitAssignLhsComputedRhs;
$(tmpCalleeParam);
