...
> Normalize > Expressions > Assignments > Compound > Auto ident nested member complex call
>
...
const tmpClusterSSA_a /*:number*/ = a * tmpInitAssignLhsComputedRhs$1;
$(tmpClusterSSA_a);
...
tmpInitAssignLhsComputedObj$1[tmpInitAssignLhsComputedProp$1] = tmpInitAssignLhsComputedRhs$1;
tmpInitAssignLhsComputedObj[tmpInitAssignLhsComputedProp] = tmpInitAssignLhsComputedRhs$1;
const tmpClusterSSA_a = { a: 999, b: 1000 } * tmpInitAssignLhsComputedRhs$1;
$(tmpClusterSSA_a);
$(tmpClusterSSA_a, b, c, 3);
`````
