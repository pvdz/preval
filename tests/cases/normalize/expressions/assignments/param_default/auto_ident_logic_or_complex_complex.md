...
let f = function (tmpParamDefault) {
  ...
  const tmpBranchingA = function (tmpParamDefault$1, p$1, tmpIfTest$1) {
    ...
    const tmpBranchingB$1 = function (tmpParamDefault$5, p$5, tmpIfTest$5, tmpCallCallee$5, tmpCalleeParam$5, tmpNestedComplexRhs$3) {
      const tmpCallCallee$6 = $;
      const tmpCalleeParam$6 = $(2);
      tmpNestedComplexRhs$3 = tmpCallCallee$6(tmpCalleeParam$6);
      const tmpReturnArg$1 = tmpBranchingC$1(tmpParamDefault$5, p$5, tmpIfTest$5, tmpCallCallee$5, tmpCalleeParam$5, tmpNestedComplexRhs$3);
...
const f = function (tmpParamDefault) {
  ...
  const tmpBranchingA = function () {
    ...
    if (tmpNestedComplexRhs$1) {
      ...
      const tmpCalleeParam$6 = $(2);
      const SSA_tmpNestedComplexRhs$3 = $(tmpCalleeParam$6);
