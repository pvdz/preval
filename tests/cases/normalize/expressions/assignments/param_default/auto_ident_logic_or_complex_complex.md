...
let f = function ($$0) {
  ...
  const tmpBranchingA = function ($$0, $$1, $$2) {
    ...
    const tmpBranchingB$1 = function ($$0, $$1, $$2, $$3, $$4, $$5) {
      ...
      tmpNestedComplexRhs$5 = tmpCallCallee$11(tmpCalleeParam$11);
      const tmpReturnArg$1 = tmpBranchingC$1(tmpParamBare$9, p$9, tmpIfTest$9, tmpCallCallee$9, tmpCalleeParam$9, tmpNestedComplexRhs$5);
...
const f = function () {
  ...
  if (tmpNestedComplexRhs$1) {
    ...
    const SSA_tmpNestedComplexRhs$1 = $(tmpCalleeParam$6);
