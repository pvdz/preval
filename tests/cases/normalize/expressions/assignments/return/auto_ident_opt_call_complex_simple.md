...
let f = function () {
  ...
  const tmpBranchingA = function ($$0, $$1, $$2) {
    ...
    const tmpReturnArg$3 = tmpBranchingC(tmpChainRootCall$1, tmpChainElementCall$3, tmpIfTest$1);
  ...
  const tmpBranchingB = function ($$0, $$1, $$2) {
    ...
    let tmpIfTest$3 = $$2;
    debugger;
    const tmpReturnArg$5 = tmpBranchingC(tmpChainRootCall$3, tmpChainElementCall$7, tmpIfTest$3);
