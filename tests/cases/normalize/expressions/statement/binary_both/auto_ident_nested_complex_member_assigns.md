...
> normalize > expressions > statement > binary_both > auto_ident_nested_complex_member_assigns
>
...
tmpNestedAssignComMemberObj$9[tmpNestedAssignComMemberProp$9] = tmpNestedPropAssignRhs$5;
