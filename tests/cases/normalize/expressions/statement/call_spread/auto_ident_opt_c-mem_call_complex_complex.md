...
`````js filename=intro
let tmpCalleeParamSpread /*:unknown*/ /*ternaryConst*/ = undefined;
const b /*:object*/ = { $: $ };
...
if (tmpIfTest) {
  ...
  if (tmpIfTest$1) {
    ...
    tmpCalleeParamSpread = $dotCall(tmpChainElementObject, tmpChainElementCall, undefined, tmpCalleeParam);
  }
}
