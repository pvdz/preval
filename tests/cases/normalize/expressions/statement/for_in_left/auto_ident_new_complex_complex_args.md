...
> Normalize > Expressions > Statement > For in left > Auto ident new complex complex args
>
...
while ($LOOP_NO_UNROLLS_LEFT) {
  ...
  if (tmpIfTest) {
    ...
    const tmpAssignMemLhsObj$1 /*:object*/ /*truthy*/ = new tmpNewCallee(tmpCalleeParam$3, tmpCalleeParam$5);
