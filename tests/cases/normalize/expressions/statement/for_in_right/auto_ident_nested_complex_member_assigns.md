...
> normalize > expressions > statement > for_in_right > auto_ident_nested_complex_member_assigns
>
...
let a = { a: 999, b: 1000 };
for (let x in ($(b)[$("x")] = $(b)[$("x")] = $(b)[$("x")] = $(b)[$("x")] = $(b)[
  $("x")
] = $(b)[$("x")] = c));
$(a, b, c);
`````
...
let a = { a: 999, b: 1000 };
{
  ...
  tmpForInDeclRhs = tmpNestedPropAssignRhs$5;
  let x;
