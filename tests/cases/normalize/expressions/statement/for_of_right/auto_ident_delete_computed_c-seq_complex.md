...
> Normalize > Expressions > Statement > For of right > Auto ident delete computed c-seq complex
>
...
const tmpForOfGenNext = $forOf(delete tmpDeleteCompObj[tmpDeleteCompProp]);
while (true) {
