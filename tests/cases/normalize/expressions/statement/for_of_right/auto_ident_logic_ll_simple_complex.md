...
> Normalize > Expressions > Statement > For of right > Auto ident logic ll simple complex
>
...
const tmpClusterSSA_tmpForOfGen /*:unknown*/ = $forOf(tmpClusterSSA_tmpCalleeParam);
