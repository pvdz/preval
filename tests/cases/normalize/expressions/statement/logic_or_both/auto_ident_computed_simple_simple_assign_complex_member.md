...
> Normalize > Expressions > Statement > Logic or both > Auto ident computed simple simple assign complex member
>
...
if (tmpIfTest) {
  ...
  const tmpCompObj$1 = $(b);
  const tmpCalleeParam$1 = $(`d`);
  const tmpAssignMemRhs = tmpCompObj$1[tmpCalleeParam$1];
