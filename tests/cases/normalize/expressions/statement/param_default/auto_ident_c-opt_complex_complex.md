...
let f = function ($$0) {
  ...
  const tmpBranchingA = function ($$0, $$1, $$2) {
    ...
    const tmpBranchingA$1 = function ($$0, $$1, $$2, $$3, $$4, $$5) {
      ...
      const tmpReturnArg = tmpBranchingC$1(tmpParamBare$7, p$7, tmpIfTest$11, tmpChainRootCall$3, tmpChainElementCall$3, tmpIfTest$13);
      return tmpReturnArg;
    };
    const tmpBranchingB$1 = function ($$0, $$1, $$2, $$3, $$4, $$5) {
      ...
      let tmpIfTest$17 = $$5;
      debugger;
      const tmpReturnArg$1 = tmpBranchingC$1(tmpParamBare$9, p$9, tmpIfTest$15, tmpChainRootCall$5, tmpChainElementCall$5, tmpIfTest$17);
    ...
    if (tmpIfTest$5) {
      const tmpReturnArg$5 = tmpBranchingA$1(tmpParamBare$1, p$1, tmpIfTest$3, tmpChainRootCall$1, tmpChainElementCall$1, tmpIfTest$5);
      return tmpReturnArg$5;
    } else {
      const tmpReturnArg$7 = tmpBranchingB$1(tmpParamBare$1, p$1, tmpIfTest$3, tmpChainRootCall$1, tmpChainElementCall$1, tmpIfTest$5);
...
const tmpBranchingA = function () {
  ...
  if (tmpIfTest$5) {
    const tmpChainRootComputed$3 = $('x');
    tmpChainElementCall$1[tmpChainRootComputed$3];
    return undefined;
  } else {
    return undefined;
  }
