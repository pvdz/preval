...
> Normalize > Expressions > Statement > Param default > Auto ident cond c-seq c-seq simple
>
...
let f = function ($$0) {
  ...
  debugger;
  let p = tmpParamBare === undefined ? ((10, 20, $(30)) ? (40, 50, $(60)) : $($(100))) : tmpParamBare;
};
let a = { a: 999, b: 1000 };
$(f());
$(a);
...
let f = function ($$0) {
  ...
  const tmpBranchingA = function ($$0, $$1, $$2) {
    ...
    const tmpBranchingA$1 = function ($$0, $$1, $$2, $$3) {
      ...
      debugger;
      p$7 = $(60);
      const tmpReturnArg = tmpBranchingC$1(tmpParamBare$7, p$7, tmpIfTest$11, tmpIfTest$13);
      return tmpReturnArg;
    };
    const tmpBranchingB$1 = function ($$0, $$1, $$2, $$3) {
      ...
      const tmpReturnArg$1 = tmpBranchingC$1(tmpParamBare$9, p$9, tmpIfTest$15, tmpIfTest$17);
    ...
    if (tmpIfTest$5) {
      const tmpReturnArg$5 = tmpBranchingA$1(tmpParamBare$1, p$1, tmpIfTest$3, tmpIfTest$5);
      return tmpReturnArg$5;
    } else {
      const tmpReturnArg$7 = tmpBranchingB$1(tmpParamBare$1, p$1, tmpIfTest$3, tmpIfTest$5);
