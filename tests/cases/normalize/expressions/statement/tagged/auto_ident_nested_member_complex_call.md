...
> Normalize > Expressions > Statement > Tagged > Auto ident nested member complex call
>
...
$(tmpCalleeParam, tmpInitAssignLhsComputedRhs$1);
...
tmpInitAssignLhsComputedObj$1[tmpInitAssignLhsComputedProp$1] = tmpInitAssignLhsComputedRhs$1;
tmpInitAssignLhsComputedObj[tmpInitAssignLhsComputedProp] = tmpInitAssignLhsComputedRhs$1;
$([`before `, ` after`], tmpInitAssignLhsComputedRhs$1);
$({ a: 999, b: 1000 }, b, c, 3);
`````
