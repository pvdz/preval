...
('<hoisted var `tmpOptionalChaining$4` decl without init>');
...
('<hoisted var `tmpTernaryAlternate$4` decl without init>');
('<hoisted var `tmpTernaryAlternate$5` decl without init>');
...
('<hoisted var `tmpTernaryTest$4` decl without init>');
('<hoisted var `tmpTernaryTest$5` decl without init>');
('<hoisted var `tmpArg` decl without init>');
('<hoisted var `tmpOptionalChaining` decl without init>');
('<hoisted var `tmpOptionalChaining$1` decl without init>');
('<hoisted var `tmpOptionalChaining$2` decl without init>');
