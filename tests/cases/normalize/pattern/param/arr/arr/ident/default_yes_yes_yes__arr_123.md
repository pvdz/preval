...
> Normalize > Pattern > Param > Arr > Arr > Ident > Default yes yes yes  arr 123
>
...
let f = function (tmpParamDefault) {
  let [[x = $('fail')] = $(['pass2'])] = tmpParamDefault === undefined ? $(['fail3']) : tmpParamDefault;
  return x;
};
$(f([1, 2, 3, 4, 5], 200));
`````
