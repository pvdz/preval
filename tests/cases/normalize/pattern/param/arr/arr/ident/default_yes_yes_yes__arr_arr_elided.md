...
> normalize > pattern >  > param > arr > arr > ident > default_yes_yes_yes__arr_arr_elided
>
...
function f($tdz$__pattern) {
  ...
  let x = tmpTernaryTest_2 ? ((tmpTernaryConsequent_2 = $('pass')), tmpTernaryConsequent_2) : arrPatternBeforeDefault_1;
  return x;
}
var tmpArg_2;
var tmpArg_3;
