...
> Normalize > Pattern > Param > Arr > Arr > Ident > Default yes yes yes  arr null
>
...
const tmpCalleeParam$9 = [null, 4, 5];
...
const tmpBranchingC$1 = function () {
  ...
  const tmpIfTest$3 = tmpssa3_arrPatternBeforeDefault$1 === undefined;
  if (tmpIfTest$3) {
    $('fail');
    return undefined;
  } else {
