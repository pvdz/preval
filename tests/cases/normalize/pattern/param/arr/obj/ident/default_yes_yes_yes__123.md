...
let f = function ($$0) {
  ...
  debugger;
  let [{ x = $('pass') } = $({ x: 'fail2' })] = tmpParamBare === undefined ? $([{ x: 'fail3' }]) : tmpParamBare;
  return 'bad';
};
$(f(1, 2, 3));
`````
...
const tmpCalleeParam$7 = f(1, 2, 3);
...
`````js filename=intro
const $clone$tmpBranchingC$0_D1 = function () {
  debugger;
  const arrPatternSplat$2 = [...1];
...
const tmpCalleeParam$7 = $clone$tmpBranchingC$0_D1();
$(tmpCalleeParam$7);
`````
