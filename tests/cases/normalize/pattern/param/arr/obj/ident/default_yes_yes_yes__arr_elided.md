...
> Normalize > Pattern > Param > Arr > Obj > Ident > Default yes yes yes  arr elided
>
...
let f = function (tmpParamDefault) {
  let [{ x = $('pass') } = $({ x: 'pass2' })] = tmpParamDefault === undefined ? $([{ x: 'fail3' }]) : tmpParamDefault;
  return x;
};
$(f([, , , 1, 20, 30], 200));
`````
...
let f = function (tmpParamDefault) {
  ...
  const tmpBranchingC = function (tmpParamDefault$3, bindingPatternArrRoot$3, tmpIfTest$3) {
    ...
    const tmpBranchingA$1 = function (
      ...
      const tmpCalleeParam$3 = { x: 'pass2' };
