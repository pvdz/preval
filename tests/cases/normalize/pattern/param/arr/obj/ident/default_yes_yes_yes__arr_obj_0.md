...
> Normalize > Pattern > Param > Arr > Obj > Ident > Default yes yes yes  arr obj 0
>
...
let f = function (tmpParamDefault) {
  let [{ x = $('fail') } = $({ x: 'fail2' })] = tmpParamDefault === undefined ? $([{ x: 'fail3' }]) : tmpParamDefault;
  return x;
};
$(f([{ x: 0, y: 2, z: 3 }, 20, 30], 200));
`````
...
const tmpArrElement$1 = { x: 0, y: 2, z: 3 };
