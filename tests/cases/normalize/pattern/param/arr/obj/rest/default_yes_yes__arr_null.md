...
const tmpCalleeParam$8 = [null, 20, 30];
...
const f = function ($$0) {
  ...
  const tmpBranchingC = function ($$0) {
    ...
    const tmpBranchingC$1 = function ($$0) {
      ...
      debugger;
      const tmpCalleeParam$5 = [];
      objPatternRest(arrPatternStep$4, tmpCalleeParam$5, undefined);
      return 'bad';
    };
    if (tmpIfTest$4) {
      const tmpCalleeParam$3 = { a: 'fail' };
      ...
      const tmpReturnArg$5 = tmpBranchingC$1(arrPatternBeforeDefault$1);
      return tmpReturnArg$5;
    }
  };
  if (tmpIfTest) {
...
const tmpCalleeParam$8 = [null, 20, 30];
const tmpCalleeParam$7 = f(tmpCalleeParam$8, 200);
$(tmpCalleeParam$7);
`````
