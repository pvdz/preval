...
# default_yes_yes_yes__obj_arr_undefined.md

> Normalize > Pattern > Param > Obj > Arr > Ident > Default yes yes yes  obj arr undefined
>
...
let f = function (tmpParamDefault) {
  let { x: [y = 'pass'] = $(['fail2']) } = tmpParamDefault === undefined ? $({ x: ['fail3'] }) : tmpParamDefault;
  return y;
};
$(f({ x: [undefined], a: 11, b: 12 }, 10));
`````
...
const tmpObjLitVal$2 = [undefined];
const tmpCalleeParam$5 = { x: tmpObjLitVal$2, a: 11, b: 12 };
