...
const tmpClusterSSA_tmpOPAD /*:unknown*/ = $(tmpCalleeParam$1);
const tmpArrPatternSplat /*:array*/ /*truthy*/ = [...tmpClusterSSA_tmpOPAD];
...
const tmpAPBD = [...tmpClusterSSA_tmpOPAD][0];
...
let tmpCalleeParam$5 = { x: undefined, a: 11, b: 12 };
