...
> normalize > pattern >  > param > obj > arr > rest > default_yes_yes__undefined
>
...
function f($tdz$__pattern) {
  ...
  let $tdz$__pattern_after_default = tmpTernaryTest
    ? ((tmpObjPropValue = ['pass2']), (tmpArg = { x: tmpObjPropValue }), (tmpTernaryConsequent = $(tmpArg)), tmpTernaryConsequent)
    : $tdz$__pattern;
