...
function f(tmpParamPattern) {
  ...
  let y_1 = tmpCallCallee$1(tmpCalleeParam$1, tmpCalleeParam$2, tmpCalleeParam$3);
  return y_1;
}
...
function f(tmpParamPattern) {
  ...
  const tmpCalleeParam$1 = objPatternAfterDefault;
  const tmpCalleeParam$2 = [];
  let y_1 = tmpCallCallee$1(tmpCalleeParam$1, tmpCalleeParam$2, undefined);
  return y_1;
}
const tmpCallCallee$2 = $;
const tmpCallCallee$3 = f;
const tmpObjLitVal = { x: 1, y: 2, z: 3 };
const tmpCalleeParam$5 = { x: tmpObjLitVal, b: 11, c: 12 };
const tmpCalleeParam$4 = tmpCallCallee$3(tmpCalleeParam$5, 10);
tmpCallCallee$2(tmpCalleeParam$4);
`````
