...
> normalize > pattern >  > param > obj > obj > rest > default_yes_yes__undefined
>
...
Should call `$` with:
[[{ x: { a: 'pass2' } }], "<crash[ Cannot read property 'x' of undefined ]>"];

Normalized calls: BAD?!
[[{ x: { a: 'pass2' } }], '<crash[ <ref> is not defined ]>'];
