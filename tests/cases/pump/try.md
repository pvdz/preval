...
while ($LOOP_DONE_UNROLLING_ALWAYS_TRUE) {
  ...
  if (tmpIfTest$5) {
    ...
    try {
      ...
      const tmpCalleeParam$47 = $dotCall(tmpMCF, arrB, `shift`);
      const tmpMCF$1 = arrB.push;
      $dotCall(tmpMCF$1, arrB, `push`, tmpCalleeParam$47);
    } catch (_0x22a091) {
      const tmpMCF$3 = arrB.shift;
      const tmpCalleeParam$49 = $dotCall(tmpMCF$3, arrB, `shift`);
      const tmpMCF$5 = arrB.push;
      $dotCall(tmpMCF$5, arrB, `push`, tmpCalleeParam$49);
    }
  }
}
