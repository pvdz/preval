...
const tmpNestedPropAssignRhs = 800;
c.width = tmpNestedPropAssignRhs;
...
R = Math.random;
let tmpForInRhs;
const tmpNestedComplexRhs$1 = c.getContext('2d');
C = tmpNestedComplexRhs$1;
tmpForInRhs = tmpNestedComplexRhs$1;
for ($ in tmpForInRhs) {
  const tmpAssignComMemLhsObj = C;
  const tmpCompObj$1 = $;
  let tmpCompProp;
  let tmpNestedComplexRhs$2;
  let tmpNestedComplexRhs$3;
  Y = 0;
  tmpNestedComplexRhs$3 = 0;
  X = tmpNestedComplexRhs$3;
  tmpNestedComplexRhs$2 = tmpNestedComplexRhs$3;
  J = tmpNestedComplexRhs$2;
  tmpCompProp = tmpNestedComplexRhs$2;
...
const tmpNestedComplexRhs$4 = function (e) {
...
onkeyup = tmpNestedComplexRhs$4;
onkeydown = tmpNestedComplexRhs$4;
`````
