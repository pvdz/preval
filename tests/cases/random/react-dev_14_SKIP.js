          ...
          var Danger = {
            ...
            dangerouslyRenderMarkup: function (markupList) {
              ...
              !(resultList.length === markupList.length)
                ? 'development' !== 'production'
                  ? invariant(false, 'Danger: Expected markup to render %s nodes, but rendered %s.', markupList.length, resultList.length)
                  : invariant(false)
                : undefined;
        ...
        function (_dereq_, module, exports) {
          ...
          var ReactCompositeComponentMixin = {
            ...
            mountComponent: function (rootID, transaction, context) {
              ...
              if ('development' !== 'production') {
                ...
                if (inst.render == null) {
                  ...
                  'development' !== 'production'
                    ? warning(
                        (Component.prototype && Component.prototype.isReactComponent) || !canInstantiate || !(inst instanceof Component),
            ...
            updateComponent: function (transaction, prevParentElement, nextParentElement, prevUnmaskedContext, nextUnmaskedContext) {
              ...
              var shouldUpdate =
                this._pendingForceUpdate || !inst.shouldComponentUpdate || inst.shouldComponentUpdate(nextProps, nextState, nextContext);
        ...
        function (_dereq_, module, exports) {
          ...
          var ReactInputSelection = {
            hasSelectionCapabilities: function (elem) {
              ...
              return (
                nodeName && ((nodeName === 'input' && elem.type === 'text') || nodeName === 'textarea' || elem.contentEditable === 'true')
              );
            },
        ...
        function (_dereq_, module, exports) {
          ...
          function getFirstCommonAncestorID(oneID, twoID) {
            ...
            !isValidID(longestCommonID)
              ? 'development' !== 'production'
                ? invariant(false, 'getFirstCommonAncestorID(%s, %s): Expected a valid React DOM ID: %s', oneID, twoID, longestCommonID)
                : invariant(false)
              : undefined;
