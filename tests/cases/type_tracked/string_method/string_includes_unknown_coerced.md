...
# string_includes_unknown_coerced.md

> Type tracked > String method > String includes unknown coerced
...
const bool = str.includes(1); // coerced to string
$(bool);
`````
...
const bool /*:boolean*/ = $dotCall($string_includes, str, `includes`, 1);
$(bool);
`````
...
const c = $dotCall( $string_includes, b, "includes", 1 );
$( c );
`````
