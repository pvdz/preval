...
# string_includes_unknown_noargs.md

> Type tracked > String method > String includes unknown noargs
...
`````js filename=intro
$($dotCall($string_includes, String($spy()), `includes`));
`````
